...
--
-- Host: localhost
-- Generation Time: Jun 02, 2017 at 11:18 PM
...
(1, 'Teste', '2017-05-31', '2017-05-02', '7865', NULL, NULL);
...
(NULL, NULL, -1, NULL, 3, 36, 'Definição automática da quantidade de atributos selecionados em tarefas de agrupamento de dados', 'Ciências da Computação e Matemática Computacional', 'Universidade de São Paulo', 'André Carlos Ponce de Leon Ferreira Carvalho', '2008', '2013', '4');
...
(28, 1, 2, '{"ano":"false","pais":"nacional"}', 'artigo', 1),
(29, 2, 4, '{"ano":"false","pais":"internacional"}', 'artigo', 1);
...
--
ALTER TABLE `regra`
  MODIFY `idRegra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
